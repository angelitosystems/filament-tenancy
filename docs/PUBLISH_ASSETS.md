...
- **USING_PLUGINS.md** - Uso de plugins de Filament
- **COMMANDS.md** - Referencia de comandos
- **multilingual-support.md** - Soporte multilingüe
...
- [Comandos del Paquete](COMMANDS.md) - Lista completa de comandos disponibles
- [Soporte Multilingüe](multilingual-support.md) - Guía detallada de idiomas
- [Configuración](CONFIGURATION.md) - Opciones de configuración del paquete
